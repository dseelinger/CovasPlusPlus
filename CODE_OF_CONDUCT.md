...
maintainer **privately** through either of these channels:

* **GitHub's private reporting** — on the [repository](https://github.com/dseelinger/CovasPlusPlus),
  use **Report content** / the **Security → Report a vulnerability** private-advisory form (it
  reaches only the maintainer, not the public), or
* **Direct message** the maintainer via their [GitHub profile](https://github.com/dseelinger).

Please do **not** report Code of Conduct violations in public issues or pull requests. All
complaints will be reviewed and investigated promptly and fairly. Community leaders are obligated
to respect the privacy and security of the reporter of any incident.

> This is a small, solo-maintained project (see the README's maintainer-status note). Reports are
> handled as promptly as a single volunteer maintainer reasonably can — your report will be read
> and taken seriously.
