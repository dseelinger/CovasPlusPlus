...
- [ ] **Look-to-place:** turn to face a spot, say *"pin the HUD here"* → the panel **swings to your gaze**, centred, keeping distance/tilt. Turn elsewhere and pin again to confirm it follows your heading. *"Reset the HUD position"* returns it to straight-ahead defaults. (With the VR overlay **off**, *"pin the HUD here"* replies that it isn't running — no crash.)
