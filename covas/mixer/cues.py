...
class Cue:
    ...
    # Optional named voice ROLE (issue #19). Empty (default) = an ordinary chatter/SFX cue routed
    # by the audio layer's normal path (random cast voice). A non-empty role (e.g. "captain",
    # "tower", "chatter") marks a carrier cue whose line the CarrierPlayer speaks in that role's
    # dedicated, independently-configured voice. Purely a routing tag — no contract impact.
    voice_role: str = ""
