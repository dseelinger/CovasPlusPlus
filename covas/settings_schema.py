...
SCHEMA: list[Setting] = [
    ...
    Setting("audio.enabled", ("audio", "enabled"), "bool",
            ...
            default=False, phrasings=("audio layer", "ambient audio", "the audio layer"),
    ...
    Setting("audio.cues.enabled", ("audio", "cues", "enabled"), "bool",
            ...
            default=False, phrasings=("space chatter", "the chatter", "ambient chatter"),
    ...
    Setting("music.enabled", ("music", "enabled"), "bool",
            ...
            default=False, phrasings=("ambient music", "the music", "background music"),
    ...
    Setting("audio.interdiction.enabled", ("audio", "interdiction", "enabled"), "bool",
            ...
            default=False, phrasings=("interdiction cue", "the interdiction alert"),
    ...
    Setting("audio.comms.voices.male", ("audio", "comms", "voices", "male"), "enum",
            "Comms voice — male", "Ambient audio",
            "ElevenLabs voice for player DMs and male-honorific NPC comms. Blank = provider default.",
            default="", options_source=OPT_EL_VOICES,
            phrasings=("male comms voice", "player comms voice")),
    Setting("audio.comms.voices.female", ("audio", "comms", "voices", "female"), "enum",
            "Comms voice — female", "Ambient audio",
            "ElevenLabs voice for female-honorific NPC comms. Blank = provider default.",
            default="", options_source=OPT_EL_VOICES,
            phrasings=("female comms voice",)),
    Setting("audio.comms.voices.default", ("audio", "comms", "voices", "default"), "enum",
            "Comms voice — default", "Ambient audio",
