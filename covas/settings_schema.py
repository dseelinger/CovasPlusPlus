...
SCHEMA: list[Setting] = [
    ...
    Setting("honk.probe_seconds", ("honk", "probe_seconds"), "float",
            "Honk probe time", "Auto-honk",
            "Unconfigured honk: length of the short test-press used to detect a Surface-Scanner "
            "misfire before the full honk.",
            default=0.4, min=0.1, max=2.0, unit="s",
            phrasings=("honk probe time", "probe time")),
