...
class HelpMeta:
    ...
    help_when_active: str | None = None
...
def _capability_help(cap: Capability) -> HelpMeta | None:
...
class CapabilityRegistry:
    ...
    def help_entries(self, *, exclude: Capability | None = None) -> list[HelpMeta]:
    ...
    def categories(self, *, exclude: Capability | None = None) -> list[str]:
    ...
    def help_entry_for(self, category: str,
                       *, exclude: Capability | None = None) -> HelpMeta | None:
    ...
    def groups(self, *, exclude: Capability | None = None) -> list[str]:
    ...
    def help_entries_in_group(self, group: str,
                              *, exclude: Capability | None = None) -> list[HelpMeta]:
    ...
    def group_for(self, name: str,
                  *, exclude: Capability | None = None) -> str | None:
    ...
    def examples(self, *, exclude: Capability | None = None) -> list[tuple[str, str]]:
    ...
    def slots_for(self, category: str,
                  *, exclude: Capability | None = None) -> tuple[Slot, ...]:
    ...
    def spansh_params_for(self, category: str,
                          *, exclude: Capability | None = None) -> list[str]:
    ...
    def slot_for_param(self, category: str, param: str,
                       *, exclude: Capability | None = None) -> Slot | None:
